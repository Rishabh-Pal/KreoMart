    ...
    <div className="gap-10 p-28 items-center justify-center  text-start">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-lg">
          ...
          (hereinafter referred to as &quot;the Website&quot;) or any services provided by
          Kreomart (hereinafter referred to as &quot;the Company&quot;), you agree to
          comply with and be bound by these Terms and Conditions (hereinafter
          referred to as &quot;Terms&quot;). If you do not agree with these Terms, please
      ...
      <div className="mb-6">
        ...
        <p className=" text-gray-600 text-lg">
          ...
          account on the Website using their mobile number. Kreomart accepts
          online payments through various online payment platforms. Users have
          the option to return purchased products, subject to our Return Policy.
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-lg">
          ...
          Policy, which can be found [here](insert link to Privacy Policy).
