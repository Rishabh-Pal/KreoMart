...
const RemainTime = () => {
  ...
  const [futureDate, setFutureDate] = useState<Date>(new Date("2023-10-25"));
      ...
      <div className="mb-5">
        <div className="flex justify-between items-center ">
          <div className="flex flex-col">
            <span className="time  sm:text-[40px] text-[24px] uppercase font-bold">
              {timeObj.days}
            </span>
            <span className="text-[10px] md:text-[16px] text-[#8991A4]">DAYS</span>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] md:text-[16px] text-[#8991A4]">HOURS</span>
          </div>
          <span className="divider text-2xl  font-bold "> : </span>
          <div className="flex flex-col">
            <span className="time sm:text-[40px] text-[24px] uppercase font-bold">
            ...
            <span className="text-[10px] md:text-[16px] text-[#8991A4]">MINUTES</span>
          </div>
          <span className="divider text-2xl font-bold ">:</span>
          <div className="flex flex-col">
            <span className="time sm:text-[40px] text-[24px] uppercase font-bold">
            ...
            <span className="text-[10px] md:text-[16px] text-[#8991A4]">SECONDS</span>
          </div>
        </div>
      </div>
    </div>
